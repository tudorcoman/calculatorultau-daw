    ...
    <head>
        ...
        <script>
            ...
            function adaugaInCos() {
                ...
                var str = "";
                mapCos.forEach((value, key) => str += `${key}|${value}`);
        ...
        <section>
            <h2>Pagină produs</h2>
                <article id="art-produs">
                    ...
                    <p>Materiale: <span class="ingrediente"><?php echo $produs["materiale"]; ?> </span></p>
                    ...
                    <div class="imag-produs"> <p> Cantitate: <input type="number" min="0" id="quantity">
